            ...
            @php
                $notifications = [
                    [
                        ...
                        'userImage' => '/images/user/user-002.jpg',
                    ...
                    [
                        ...
                        'userImage' => '/images/user/user-003.jpg',
                        'action' => 'requests permission to change',
                        'project' => 'Project - Nganter App',
                        'type' => 'Project',
                        'time' => '10 min ago',
                    ...
                    [
                        ...
                        'userImage' => '/images/user/user-004.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        'id' => 4,
                        'userName' => 'Mike Brown',
                        'userImage' => '/images/user/user-005.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        'id' => 5,
                        'userName' => 'Emma Davis',
                        'userImage' => '/images/user/user-006.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        'id' => 6,
                        'userName' => 'John Smith',
                        'userImage' => '/images/user/user-007.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        ...
                        'userImage' => '/images/user/user-008.jpg',
                        'action' => 'requests permission to change',
                    ...
                    [
                        ...
                        'userImage' => '/images/user/user-009.jpg',
                        'action' => 'requests permission to change',
                ...
                <li @click="handleItemClick()">
                    ...
                    >
                        <x-ui.avatar 
                            ...
                            :image="$notification['userImage'] ?? null" 
